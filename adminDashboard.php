		...
		<ul class="nav-links" style="list-style-type:none;">
			...
			<li>
				<a href="#">
					...
					<span class="link_name">Edit new Tour </span>
				</a>
			</li>
			...
			<li>
				<a href="#">
					...
					<span class="link_name">Delete old Trip</span>
				</a>
			</li>
	...
	<section class="home-section">
        ...
        <div class="home-content">
        	<div class="overview-boxes">
        		<div class="box">
        			<div class="left-side">
        				<div class="box-topic">User Booked list</div>
        		...
        		<div class="box">
        			<div class="left-side">
        				<div class="box-topic">Modify Packages</div>
        				<div class="number">40</div>
        				<div><i class='bx bx-book-content booked'></i></div>
        			</div>
        		</div>

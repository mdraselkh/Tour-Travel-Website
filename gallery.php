...
<body>
   ...
   <header class="header">
	...
	<div class="heading" style="background:url(gallerybg.jpg) no-repeat">
   <h1>Gallery</h1>
   </div>



<section class="packages" id="gallery">
    ...
    <h1 class="heading-title">
      ...
      <div class="box">
         ...
         <div class="content">
		   ...
		   <p>&nbsp;  Traveling – it leaves you speechless, then turns<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		    &nbsp;&nbsp;&nbsp;you into a storyteller! </p>
